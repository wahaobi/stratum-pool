...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients) {
    ...
    if (!fBBP) 
    {
        // RPC must return 'previousblockhash'
    ...
    this.getJobParams = function () {
        if (!this.jobParams) {
            ...
            var iRandomize = Math.floor(Math.random() * 120) - 60;
            ...
            this.jobParams = [
                ...
                this.rpcData.bits,
                util.packUInt32BE(this.rpcData.curtime + iRandomize).toString('hex'),
                true
            ];
