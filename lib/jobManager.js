...
var JobManager = module.exports = function JobManager(options) {
    ...
    this.processGBT = function (rpcData) {
        ...
        // console.log('created block for clients %s ', sHex);
    ...
    this.processShare = function (jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName, pobhhash, blockHex, x11hash, sRecipient, nABNPassed, sPoolAddress) {
